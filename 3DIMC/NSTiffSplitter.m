...
-(NSString *)titleForImage_270:(NSTiffSplitter *)splitter index:(int)index{
    int ifdOffset = [self.IFDOffsets[index] intValue];
    int countOfFields = [self valueForBytesAt:ifdOffset count:2];
    
    for (int i = 0; i < countOfFields; i++) {
        int tagNumber = [self valueForBytesAt:ifdOffset + 2 + i * 12 count:2];
        //int tagType = [self valueForBytesAt:ifdOffset + 2 + i * 12 + 2 count:2];
