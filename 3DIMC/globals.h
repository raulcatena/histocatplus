...
//SAVING THE 3D-STATE
#define THREE_D_POSITIONS @"3DPOSS"
...
#define METAL_LEFT_X_OFFSET @"METAL_LEFT_X_OFFSET"
#define METAL_RIGHT_X_OFFSET @"METAL_RIGHT_X_OFFSET"
#define METAL_LOWER_Y_OFFSET @"METAL_LOWER_Y_OFFSET"
#define METAL_UPPER_Y_OFFSET @"METAL_UPPER_Y_OFFSET"
#define METAL_NEAR_Z_OFFSET @"METAL_NEAR_Z_OFFSET"
#define METAL_FAR_Z_OFFSET @"METAL_FAR_Z_OFFSET"
